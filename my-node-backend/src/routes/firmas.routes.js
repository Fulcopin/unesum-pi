...
router.get(
  '/pendientes',
  authorize(['docente', 'profesor', 'comision', 'comision_academica', 'direccion', 'decano', 'subdecano', 'administrador']),
...
router.get(
  '/reporte-qr',
  authorize(['administrador', 'decano', 'direccion']),
...
router.get(
  '/qr-por-documento',
  authorize(['administrador', 'decano', 'direccion', 'comision', 'comision_academica']),
...
router.post(
  '/firmar-masivo',
  authorize(['decano', 'direccion', 'administrador']),
...
router.get(
  '/:tipo/:id',
  authorize(['docente', 'profesor', 'comision', 'comision_academica', 'direccion', 'decano', 'subdecano', 'administrador', 'estudiante']),

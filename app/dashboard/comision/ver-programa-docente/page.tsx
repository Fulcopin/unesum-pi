...
interface TabCell {
  ...
  styles?: { backgroundColor?: string; textColor?: string; textAlign?: string; textOrientation?: string };
}
              ...
              {row.cells.map(cell => {
                ...
                return (
                  <Tag
                    ...
                    style={{ backgroundColor: cell.backgroundColor || cell.styles?.backgroundColor || undefined }}
          ...
          <div className="p-4 overflow-auto flex-1">
            {hasTabs
              ? tabActual?.rows?.length
                ? <ReadOnlyTable rows={tabActual.rows} />
